    ...
    for mult_ref in [1]:
        for roi_type in ["roi-c", "roi-p"]:
            for problem_name in ["DTLZ1", "DTLZ2","DTLZ3", "DTLZ4", "DTLZ5", "DTLZ6", "DTLZ7"]: #"DTLZ1", "DTLZ3", "DTLZ4", "WFG1", "WFG2", "WFG3", "WFG4", "WFG5", "WFG6", "WFG7", "WFG8", "WFG9"
                for alg in ['NSGA2','SMSEMOA','IBEA','NSGA3','SPEA2','BNSGA2','BIBEA','BSMSEMOA','BNSGA3','BSPEA2','BNSGA2-drs','BSPEA2-drs','RNSGA2','gNSGA2']: #'BNSGA2', 'BIBEA', 'BSMSEMOA', 'RNSGA2-no','RNSGA2', 'gNSGA2', "IBEA", "SMSEMOA", "NSGA2"
                    if alg == "RNSGA2" and roi_type =="roi-p":
                        continue
                    if alg == "gNSGA2" and roi_type =="roi-c":
                        continue
                    for n_obj in [2,4,6]:          
                        args = f'--n_obj {n_obj} --problem_name {problem_name} --alg {alg} --roi_type {roi_type} --mult_ref {mult_ref}'
