...
if __name__ == '__main__':
    ...
    for roi_type in ["roi-c", "roi-p"]:
        for problem_name in ["DTLZ1", "DTLZ2", "DTLZ3", "DTLZ4", "DTLZ5", "DTLZ6", "DTLZ7"]:
            for alg in ['BNSGA2', 'BIBEA', "BSMSEMOA", "NSGA2", "IBEA", "SMSEMOA", "RNSGA2", "gNSGA2"]: #'BNSGA2', 'BIBEA', 'BSMSEMOA', 'RNSGA2-no','RNSGA2', 'gNSGA2', "IBEA", "SMSEMOA", "NSGA2"
                ...
                for n_obj in [3,5]:
                    for run_id in range(31):            
                        args = f'--n_obj {n_obj} --problem_name {problem_name} --alg {alg} --run_id {run_id} --roi_type {roi_type}'
